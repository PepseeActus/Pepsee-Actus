    ...
    <div>
        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            $perso = get_field('info_perso'); 
                ...
                <div class="artist-perso">
                    ...
                    <ul>
	                                ...
	                                <?php
	                                    ...
	                                    foreach ($genres as $genre) {
	                                        if ($genre instanceof WP_Term) {
	                                            ...
	                                            $term = get_term((int) $genre, 'genre');
	                                            if ($term && ! is_wp_error($term)) {
	                                                $links[] = '<a href="' . esc_url(get_term_link($term)) . '"><u>' . esc_html($term->name) . '</u></a>';
	                                            }
	                                        } elseif (is_string($genre) && $genre !== '') {
	                                            $links[] = esc_html($genre);
	                                        }
	                                    }
	                                    echo implode(' / ', $links);
	                                ?>
                        ...
                        <?php endif; ?>
                        <?php if ($credits): ?>
                            <li><b>Crédits</b> : <?php echo $credits; ?></li>
                        <?php endif; ?>
                        <?php if ($internet): ?>
            ...
            <div class="artist-music">
                <?php $music_posts = get_field('musique_associees');
